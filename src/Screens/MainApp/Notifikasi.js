import { StyleSheet, Text, View ,SafeAreaView,StatusBar,Dimensions,Image, TouchableOpacity} from 'react-native'
  ...
  return (
    ...
    <ScrollView>
      <View style={{margin:16,marginTop:46}}>
        ...
        {arr.map(a=>{
          return(
            <TouchableOpacity key={a} style={{flexDirection:'row',marginTop:24,}}>
              ...
              <View style={{flexDirection:'column',marginLeft:16}}>
                <View style={{flexDirection:'row',justifyContent:'space-between' ,paddingRight:30}}>
                  ...
                  <Text style={styles.textBlack}>Berhasil Ditawar Rp. 200.000</Text>
                <View style={{flexWrap:'wrap',width:window.width*0.82,flexDirection:'row'}}>
                  <Text style={[styles.textGrey]}>Kamu akan segera dihubungi penjual via whatsapp</Text>
                </View>
              </View>
            </TouchableOpacity>
              )
