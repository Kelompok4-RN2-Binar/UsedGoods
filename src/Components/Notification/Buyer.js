...
import { getNotificationBuyer ,getDetailNotification,readNotif} from '../../Redux/actions';
...
const Buyer = () => {
  ...
  const onRefresh = useCallback(() => {
    dispatch(getNotificationBuyer(loginUser.access_token)).then(()=>{setRefreshing(true)})
    wait(500).then(() => {
      setRefreshing(false);
    });
  }, []);
        ...
        <View style={{width:window.width}}>
          ...
          <View style={{justifyContent:'center',alignItems:'center',width:window.width*0.9,alignSelf:'center'}}>
            {dataDetail.status=="accepted" && 
              ...
              <Text style={[styles.textGrey,{alignSelf:'center',fontSize:14}]}>Immediately contact the seller via whatsapp for further transactions</Text>
              ...
              <>
              <Text style={[styles.Text,{alignSelf:'center',fontSize:14,paddingTop:10,fontFamily:FONTS.SemiBold,color:COLORS.red}]}>Mehh your order got declined by seller :( </Text>
              <Text style={[styles.textGrey,{alignSelf:'center',fontSize:14}]}>Hope you get best price in other product!</Text>    
              ...
              <View style={{flexDirection: 'column', marginLeft: 15}}>
                <View
                  ...
                  {item.status == 'accepted' ? (
                    ...
                    <Text style={[styles.textGrey,{color:COLORS.red}]}>Offer Declined</Text>
                  )}
